...
GO
/****** Object:  StoredProcedure [dbo].[lin_AddOfflineShop]    Script Date: 09/24/2019 05:04:07 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
	...
	-- insert new shop
	INSERT INTO offline_shop (shop_text, shop_type, shop_owner_id) VALUES(@shop_text, @shop_type, @shop_owner)
	SELECT @@IDENTITY
END

/****** Object:  StoredProcedure [dbo].[lin_UpdateOfflineShopItemCount]    Script Date: 10/09/2017 16:53:47 ******/
...
/****** Object:  StoredProcedure [dbo].[lin_AddOfflineBuffShop]    Script Date: 09/24/2019 02:58:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
	...
	-- insert new shop
	INSERT INTO offline_shop_buff (shop_text, shop_owner_id, price) VALUES(@shop_text, @shop_owner, @shop_price)
	SELECT @@IDENTITY
END
GO
